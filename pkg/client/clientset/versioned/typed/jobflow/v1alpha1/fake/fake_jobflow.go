...
import (
	...
	v1alpha1 "github.com/myoperator/jobflowoperator/pkg/apis/jobflow/v1alpha1"
...
var jobflowsResource = schema.GroupVersionResource{Group: "api.practice.com", Version: "v1alpha1", Resource: "jobflows"}

var jobflowsKind = schema.GroupVersionKind{Group: "api.practice.com", Version: "v1alpha1", Kind: "JobFlow"}
...
func (c *FakeJobFlows) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(jobflowsResource, c.ns, name), &v1alpha1.JobFlow{})
