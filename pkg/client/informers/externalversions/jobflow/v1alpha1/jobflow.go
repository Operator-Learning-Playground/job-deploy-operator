...
import (
	...
	v1alpha1 "github.com/myoperator/jobflowoperator/pkg/client/listers/jobflow/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha1().JobFlows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().JobFlows(namespace).Watch(context.TODO(), options)
			},
		},
		&jobflowv1alpha1.JobFlow{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jobFlowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jobflowv1alpha1.JobFlow{}, f.defaultInformer)
}
